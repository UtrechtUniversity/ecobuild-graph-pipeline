# ponytail: duplicated from paper-crawler/crawler/rate_limiter.py rather than a
# shared pip package — each crawler is its own Docker build context/poetry
# project, and with only two crawlers a cross-service package isn't earning
# its cost yet. Extract to a shared package if a third crawler shows up.
