# ponytail: duplicated from paper-crawler/crawler/service.py — fully generic
# start/stop/status/queries wrapper, no Scopus-specific logic. Extract to a
# shared package if a third crawler shows up.
import threading
